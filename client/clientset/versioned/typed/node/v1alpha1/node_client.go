...
// NodeV1alpha1Client is used to interact with features provided by the node.k8s.appscode.com group.
type NodeV1alpha1Client struct {
	restClient rest.Interface
}

func (c *NodeV1alpha1Client) NodeTopologies() NodeTopologyInterface {
