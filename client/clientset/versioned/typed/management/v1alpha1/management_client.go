...
// ManagementV1alpha1Client is used to interact with features provided by the management.k8s.appscode.com group.
type ManagementV1alpha1Client struct {
	restClient rest.Interface
}

func (c *ManagementV1alpha1Client) ProjectQuotas() ProjectQuotaInterface {
	return newProjectQuotas(c)
}
...
func setConfigDefaults(config *rest.Config) {
	gv := managementv1alpha1.SchemeGroupVersion
