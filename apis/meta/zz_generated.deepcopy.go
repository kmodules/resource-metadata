...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *StatusColorCode) DeepCopyInto(out *StatusColorCode) {
	*out = *in
	if in.Green != nil {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new StatusColorCode.
func (in *StatusColorCode) DeepCopy() *StatusColorCode {
	if in == nil {
		return nil
	}
	out := new(StatusColorCode)
	in.DeepCopyInto(out)
	return out
}
