...
func RegisterConversions(s *runtime.Scheme) error {
	...
	if err := s.AddGeneratedConversionFunc((*ResourceDetails)(nil), (*meta.ResourceDetails)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_v1alpha1_ResourceDetails_To_meta_ResourceDetails(a.(*ResourceDetails), b.(*meta.ResourceDetails), scope)
	}); err != nil {
		return err
	}
	if err := s.AddGeneratedConversionFunc((*meta.ResourceDetails)(nil), (*ResourceDetails)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_meta_ResourceDetails_To_v1alpha1_ResourceDetails(a.(*meta.ResourceDetails), b.(*ResourceDetails), scope)
	}); err != nil {
		return err
	}
...
func autoConvert_v1alpha1_ResourceDescriptorSpec_To_meta_ResourceDescriptorSpec(in *ResourceDescriptorSpec, out *meta.ResourceDescriptorSpec, s conversion.Scope) error {
	...
	if err := Convert_v1alpha1_ResourceDetails_To_meta_ResourceDetails(&in.Details, &out.Details, s); err != nil {
		return err
	}
...
func autoConvert_meta_ResourceDescriptorSpec_To_v1alpha1_ResourceDescriptorSpec(in *meta.ResourceDescriptorSpec, out *ResourceDescriptorSpec, s conversion.Scope) error {
	...
	if err := Convert_meta_ResourceDetails_To_v1alpha1_ResourceDetails(&in.Details, &out.Details, s); err != nil {
		return err
	}
...
func autoConvert_v1alpha1_ResourceDetails_To_meta_ResourceDetails(in *ResourceDetails, out *meta.ResourceDetails, s conversion.Scope) error {
	out.Fields = *(*[]meta.ResourceColumnDefinition)(unsafe.Pointer(&in.Fields))
	out.SubTabled = *(*[]meta.ResourceSubTableDefinition)(unsafe.Pointer(&in.SubTabled))
	return nil
}

// Convert_v1alpha1_ResourceDetails_To_meta_ResourceDetails is an autogenerated conversion function.
func Convert_v1alpha1_ResourceDetails_To_meta_ResourceDetails(in *ResourceDetails, out *meta.ResourceDetails, s conversion.Scope) error {
	return autoConvert_v1alpha1_ResourceDetails_To_meta_ResourceDetails(in, out, s)
}

func autoConvert_meta_ResourceDetails_To_v1alpha1_ResourceDetails(in *meta.ResourceDetails, out *ResourceDetails, s conversion.Scope) error {
	out.Fields = *(*[]ResourceColumnDefinition)(unsafe.Pointer(&in.Fields))
	out.SubTabled = *(*[]ResourceSubTableDefinition)(unsafe.Pointer(&in.SubTabled))
	return nil
}

// Convert_meta_ResourceDetails_To_v1alpha1_ResourceDetails is an autogenerated conversion function.
func Convert_meta_ResourceDetails_To_v1alpha1_ResourceDetails(in *meta.ResourceDetails, out *ResourceDetails, s conversion.Scope) error {
	return autoConvert_meta_ResourceDetails_To_v1alpha1_ResourceDetails(in, out, s)
}
