...
func RegisterConversions(s *runtime.Scheme) error {
	...
	if err := s.AddGeneratedConversionFunc((*StatusColorCode)(nil), (*meta.StatusColorCode)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_v1alpha1_StatusColorCode_To_meta_StatusColorCode(a.(*StatusColorCode), b.(*meta.StatusColorCode), scope)
	}); err != nil {
		return err
	}
	if err := s.AddGeneratedConversionFunc((*meta.StatusColorCode)(nil), (*StatusColorCode)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_meta_StatusColorCode_To_v1alpha1_StatusColorCode(a.(*meta.StatusColorCode), b.(*StatusColorCode), scope)
	}); err != nil {
		return err
	}
...
func autoConvert_v1alpha1_RelatedResourcePage_To_meta_RelatedResourcePage(in *RelatedResourcePage, out *meta.RelatedResourcePage, s conversion.Scope) error {
	out.Name = in.Name
	out.Resources = *(*[]v1.TypeMeta)(unsafe.Pointer(&in.Resources))
...
func autoConvert_v1alpha1_ResourceDescriptorSpec_To_meta_ResourceDescriptorSpec(in *ResourceDescriptorSpec, out *meta.ResourceDescriptorSpec, s conversion.Scope) error {
	...
	if err := Convert_v1alpha1_StatusColorCode_To_meta_StatusColorCode(&in.Status, &out.Status, s); err != nil {
		return err
	}
...
func autoConvert_meta_ResourceDescriptorSpec_To_v1alpha1_ResourceDescriptorSpec(in *meta.ResourceDescriptorSpec, out *ResourceDescriptorSpec, s conversion.Scope) error {
	...
	if err := Convert_meta_StatusColorCode_To_v1alpha1_StatusColorCode(&in.Status, &out.Status, s); err != nil {
		return err
	}
	if in.Validation != nil {
		in, out := &in.Validation, &out.Validation
...
func autoConvert_v1alpha1_StatusColorCode_To_meta_StatusColorCode(in *StatusColorCode, out *meta.StatusColorCode, s conversion.Scope) error {
	out.Green = *(*[]string)(unsafe.Pointer(&in.Green))
	out.Red = *(*[]string)(unsafe.Pointer(&in.Red))
	out.Yellow = *(*[]string)(unsafe.Pointer(&in.Yellow))
	return nil
}

// Convert_v1alpha1_StatusColorCode_To_meta_StatusColorCode is an autogenerated conversion function.
func Convert_v1alpha1_StatusColorCode_To_meta_StatusColorCode(in *StatusColorCode, out *meta.StatusColorCode, s conversion.Scope) error {
	return autoConvert_v1alpha1_StatusColorCode_To_meta_StatusColorCode(in, out, s)
}

func autoConvert_meta_StatusColorCode_To_v1alpha1_StatusColorCode(in *meta.StatusColorCode, out *StatusColorCode, s conversion.Scope) error {
	out.Green = *(*[]string)(unsafe.Pointer(&in.Green))
	out.Red = *(*[]string)(unsafe.Pointer(&in.Red))
	out.Yellow = *(*[]string)(unsafe.Pointer(&in.Yellow))
	return nil
...
// Convert_meta_StatusColorCode_To_v1alpha1_StatusColorCode is an autogenerated conversion function.
func Convert_meta_StatusColorCode_To_v1alpha1_StatusColorCode(in *meta.StatusColorCode, out *StatusColorCode, s conversion.Scope) error {
	return autoConvert_meta_StatusColorCode_To_v1alpha1_StatusColorCode(in, out, s)
}
