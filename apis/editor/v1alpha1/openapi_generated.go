...
func GetOpenAPIDefinitions(ref common.ReferenceCallback) map[string]common.OpenAPIDefinition {
	return map[string]common.OpenAPIDefinition{
		...
		"kmodules.xyz/resource-metadata/apis/editor/v1alpha1.EditorRender":           schema_resource_metadata_apis_editor_v1alpha1_EditorRender(ref),
		"kmodules.xyz/resource-metadata/apis/editor/v1alpha1.EditorRenderRequest":    schema_resource_metadata_apis_editor_v1alpha1_EditorRenderRequest(ref),
		"kmodules.xyz/resource-metadata/apis/editor/v1alpha1.EditorRenderResponse":   schema_resource_metadata_apis_editor_v1alpha1_EditorRenderResponse(ref),
		"kmodules.xyz/resource-metadata/apis/editor/v1alpha1.EditorTemplate":         schema_resource_metadata_apis_editor_v1alpha1_EditorTemplate(ref),
		"kmodules.xyz/resource-metadata/apis/editor/v1alpha1.EditorTemplateRequest":  schema_resource_metadata_apis_editor_v1alpha1_EditorTemplateRequest(ref),
		"kmodules.xyz/resource-metadata/apis/editor/v1alpha1.EditorTemplateResponse": schema_resource_metadata_apis_editor_v1alpha1_EditorTemplateResponse(ref),
...
func schema_resource_metadata_apis_editor_v1alpha1_EditorRender(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Description: "EditorRender renders an editor model, manifest or resources from a set of options, without touching any existing installation. It is the read-only aggregated-API equivalent of the b3 /clusters/{owner}/{cluster}/helm/options/{model,manifest,resources} endpoints.",
				Type:        []string{"object"},
				Properties: map[string]spec.Schema{
					"kind": {
						SchemaProps: spec.SchemaProps{
					...
					"request": {
						SchemaProps: spec.SchemaProps{
							Description: "Request describes what to render.",
							Ref:         ref("kmodules.xyz/resource-metadata/apis/editor/v1alpha1.EditorRenderRequest"),
						},
					},
					"response": {
						SchemaProps: spec.SchemaProps{
							Description: "Response holds the rendered output.",
							Ref:         ref("kmodules.xyz/resource-metadata/apis/editor/v1alpha1.EditorRenderResponse"),
						},
					},
				},
			},
		...
		Dependencies: []string{
			"kmodules.xyz/resource-metadata/apis/editor/v1alpha1.EditorRenderRequest", "kmodules.xyz/resource-metadata/apis/editor/v1alpha1.EditorRenderResponse"},
	}
}

func schema_resource_metadata_apis_editor_v1alpha1_EditorRenderRequest(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Type: []string{"object"},
				Properties: map[string]spec.Schema{
					"chartRef": {
						SchemaProps: spec.SchemaProps{
							Description: "ChartRef optionally selects the chart source. When unset, the resource editor chart resolved from the options metadata is used.",
							Ref:         ref("x-helm.dev/apimachinery/apis/releases/v1alpha1.ChartSourceFlatRef"),
						},
					},
					"options": {
						SchemaProps: spec.SchemaProps{
							Description: "Options is the editor options model (values) to render from.",
							Ref:         ref("k8s.io/apimachinery/pkg/runtime.RawExtension"),
						},
					},
					"output": {
						SchemaProps: spec.SchemaProps{
							Description: "Output selects which artifact to render. Defaults to \"resources\".",
							Type:        []string{"string"},
							Format:      "",
						},
					},
					"skipCRDs": {
						SchemaProps: spec.SchemaProps{
							Description: "SkipCRDs omits CRDs from the resources output.",
							Type:        []string{"boolean"},
							Format:      "",
						},
					},
		...
		Dependencies: []string{
			"k8s.io/apimachinery/pkg/runtime.RawExtension", "x-helm.dev/apimachinery/apis/releases/v1alpha1.ChartSourceFlatRef"},
	}
}

func schema_resource_metadata_apis_editor_v1alpha1_EditorRenderResponse(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Type: []string{"object"},
				Properties: map[string]spec.Schema{
					"model": {
						SchemaProps: spec.SchemaProps{
							Description: "Model is set when Output is \"model\": the generated editor model (values).",
							Ref:         ref("k8s.io/apimachinery/pkg/runtime.RawExtension"),
						},
					},
					"manifest": {
						SchemaProps: spec.SchemaProps{
							Description: "Manifest is set when Output is \"manifest\": the rendered YAML manifest.",
							Type:        []string{"string"},
							Format:      "",
						},
					},
					"resources": {
						SchemaProps: spec.SchemaProps{
							Description: "Resources is set when Output is \"resources\": the rendered CRDs + resources.",
							Ref:         ref("x-helm.dev/apimachinery/apis/releases/v1alpha1.ResourceOutput"),
						},
					},
				},
			},
		...
		Dependencies: []string{
			"k8s.io/apimachinery/pkg/runtime.RawExtension", "x-helm.dev/apimachinery/apis/releases/v1alpha1.ResourceOutput"},
	}
}

func schema_resource_metadata_apis_editor_v1alpha1_EditorTemplate(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Description: "EditorTemplate loads the editor model, manifest or resources for an existing installation identified by Metadata. It is the read-only aggregated-API equivalent of the b3 /clusters/{owner}/{cluster}/helm/editor/{model,manifest,resources} endpoints.",
				Type:        []string{"object"},
				Properties: map[string]spec.Schema{
					"kind": {
						SchemaProps: spec.SchemaProps{
					...
					"request": {
						SchemaProps: spec.SchemaProps{
							Description: "Request identifies the installation and what to load.",
							Ref:         ref("kmodules.xyz/resource-metadata/apis/editor/v1alpha1.EditorTemplateRequest"),
						},
					},
					"response": {
						SchemaProps: spec.SchemaProps{
							Description: "Response holds the loaded output.",
							Ref:         ref("kmodules.xyz/resource-metadata/apis/editor/v1alpha1.EditorTemplateResponse"),
						},
					},
				},
			},
		...
		Dependencies: []string{
			"kmodules.xyz/resource-metadata/apis/editor/v1alpha1.EditorTemplateRequest", "kmodules.xyz/resource-metadata/apis/editor/v1alpha1.EditorTemplateResponse"},
	}
}

func schema_resource_metadata_apis_editor_v1alpha1_EditorTemplateRequest(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Type: []string{"object"},
				Properties: map[string]spec.Schema{
					"chartRef": {
						SchemaProps: spec.SchemaProps{
							Description: "ChartRef optionally selects the chart source. When unset, the resource editor chart resolved from Metadata is used.",
							Ref:         ref("x-helm.dev/apimachinery/apis/releases/v1alpha1.ChartSourceFlatRef"),
						},
					},
					"metadata": {
						SchemaProps: spec.SchemaProps{
							Description: "Metadata identifies the installed release (resource id + release name/namespace).",
							Default:     map[string]interface{}{},
					...
					"output": {
						SchemaProps: spec.SchemaProps{
							Description: "Output selects which artifact to load. Defaults to \"resources\".",
							Type:        []string{"string"},
							Format:      "",
						},
					},
...
func schema_resource_metadata_apis_editor_v1alpha1_EditorTemplateResponse(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Type: []string{"object"},
				Properties: map[string]spec.Schema{
					"values": {
						SchemaProps: spec.SchemaProps{
							Description: "Values is set when Output is \"model\": the editor model (values) of the install.",
							Ref:         ref("k8s.io/apimachinery/pkg/runtime.RawExtension"),
						},
					},
					"manifest": {
					...
					"resources": {
						SchemaProps: spec.SchemaProps{
							Description: "Resources is set when Output is \"resources\": the CRDs + resources.",
							Ref:         ref("x-helm.dev/apimachinery/apis/releases/v1alpha1.ResourceOutput"),
						},
					},
				},
