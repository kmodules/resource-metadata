...
func GetOpenAPIDefinitions(ref common.ReferenceCallback) map[string]common.OpenAPIDefinition {
	return map[string]common.OpenAPIDefinition{
		...
		"kmodules.xyz/resource-metadata/apis/editor/v1alpha1.EditorTemplateResource": schema_resource_metadata_apis_editor_v1alpha1_EditorTemplateResource(ref),
...
func schema_resource_metadata_apis_editor_v1alpha1_EditorTemplate(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Description: "EditorTemplate loads the editor model, manifest and resources for an existing installation identified by its metadata. It is the aggregated-API equivalent of kubepack.dev/lib-app/pkg/editor.LoadResourceEditorModel (see chart_template.go loadEditorModel2).",
				Type:        []string{"object"},
				Properties: map[string]spec.Schema{
					"kind": {
						SchemaProps: spec.SchemaProps{
...
func schema_resource_metadata_apis_editor_v1alpha1_EditorTemplateResource(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Type: []string{"object"},
...
func schema_resource_metadata_apis_editor_v1alpha1_EditorTemplateResponse(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
						...
						SchemaProps: spec.SchemaProps{
							...
							Items: &spec.SchemaOrArray{
								Schema: &spec.Schema{
									SchemaProps: spec.SchemaProps{
										Default: map[string]interface{}{},
										Ref:     ref("kmodules.xyz/resource-metadata/apis/editor/v1alpha1.EditorTemplateResource"),
									},
								},
							},
						},
		...
		Dependencies: []string{
			"k8s.io/apimachinery/pkg/runtime.RawExtension", "kmodules.xyz/resource-metadata/apis/editor/v1alpha1.EditorTemplateResource"},
	}
}
